  ...
  return (
    <section className="relative min-h-screen pt-20 md:pt-32 pb-12 md:pb-20 px-4 md:px-8 flex flex-col justify-between overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center mb-8 md:mb-12 relative z-10">
        ...
        >
          <h1 className="font-sans text-[7.5vw] md:text-[6vw] lg:text-[7.5vw] font-bold tracking-[0.05em] uppercase leading-none text-center mix-blend-difference">
            KIMPPOP
          </h1>
          <span className="font-sans text-sm md:text-lg lg:text-2xl absolute -right-8 md:-right-12 lg:-right-16 top-0 md:top-1 lg:top-2 text-gray-400">(DEV)</span>
        </motion.div>
      </div>

      {/* Nav Row */}
      {/* Nav Row */}
      <div className="w-full flex flex-col md:grid md:grid-cols-5 gap-6 md:gap-4 border-t border-gray-200 pt-6 md:pt-4 text-3xl md:text-2xl font-sans uppercase tracking-wide mb-8 md:mb-0">
      ...
      <div className="flex-1 flex flex-col md:grid md:grid-cols-12 gap-4 md:gap-8 items-end relative mt-4 md:mt-0">
        ...
        <div className="order-1 md:order-2 md:col-span-6 flex justify-center items-end relative min-h-[15vh] md:min-h-[40vh] w-full">
          ...
          <motion.div
            className="absolute -bottom-6 md:-bottom-10 text-[9px] md:text-[10px] uppercase tracking-wider opacity-60 hidden md:block"
            initial={{ opacity: 0 }}
            animate={{ opacity: 0.6 }}
            transition={{ delay: 2 }}
          >
        ...
        {/* Right Text */}
        <motion.div
          className="order-3 md:order-3 md:col-span-3 text-[10px] md:text-xs leading-relaxed uppercase w-full md:max-w-[240px] md:text-right md:justify-self-end mt-4 md:mt-0"
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 1.4, duration: 1 }}
        >
          <div className="mb-2 md:mb-4 text-xl md:text-2xl flex md:justify-end">✦</div>
